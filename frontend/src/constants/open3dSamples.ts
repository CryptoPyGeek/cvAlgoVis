...
export const OPEN3D_SAMPLES: Open3DSampleDef[] = [
  {
    ...
    recommendedAlgorithms: ["segment_plane", "remove_statistical_outlier", "remove_radius_outlier"]
  },
  {
    id: "cube-lattice",
    label: "立方体格点",
    ...
    recommendedAlgorithms: ["voxel_down_sample", "estimate_normals", "uniform_down_sample"]
  },
  {
    id: "layered-ramp",
    label: "分层斜坡",
    ...
    recommendedAlgorithms: ["estimate_normals", "voxel_down_sample", "crop_axis_aligned_bbox"]
  },
  {
    id: "sphere-shell",
    label: "球壳点云",
    ...
    recommendedAlgorithms: ["estimate_normals", "voxel_down_sample", "random_down_sample"]
  }
];
