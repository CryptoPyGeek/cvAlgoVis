...
export const OPEN3D_SAMPLES: Open3DSampleDef[] = [
  {
    ...
    recommendedAlgorithms: ["segment_plane", "remove_statistical_outlier"]
  },
  {
    id: "cube-lattice",
    label: "立方体格点",
    ...
    recommendedAlgorithms: ["voxel_down_sample", "estimate_normals"]
  },
  {
    id: "layered-ramp",
    label: "分层斜坡",
    ...
    recommendedAlgorithms: ["estimate_normals", "voxel_down_sample"]
  },
  {
    id: "sphere-shell",
    label: "球壳点云",
